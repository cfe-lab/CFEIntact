...
DEFAULT_FORWARD_ORFs: ORFsDefinition \
    = [("gag", 790, 2292, 39, 201, Fraction("0.66")),
       ("pol", 2085, 5096, 91, 21, Fraction("0.76")),
       ("env", 6225, 8795, 54, 363, Fraction("0.69"))]
DEFAULT_REVERSE_ORFS: ORFsDefinition = []
DEFAULT_SMALL_FORWARD_ORFS: ORFsDefinition \
    = [("vif", 5041, 5619, 3, 3, Fraction("0.69")),
       ("vpr", 5559, 5850, 6, 3, Fraction("0.50")),
       ("tat_exon1", 5831, 6045, 0, 0, Fraction("0.61")),
       ("rev_exon1", 5970, 6045, 0, 0, Fraction("0.60")),
       ("vpu", 6062, 6310, 6, 24, Fraction("0.75")),
       ("tat_exon2", 8377, 8469, 0, 3, Fraction("0.70")),
       ("rev_exon2", 8378, 8653, 6, 3, Fraction("0.61")),
       ("nef", 8797, 9417, 48, 51, Fraction("0.68"))]
